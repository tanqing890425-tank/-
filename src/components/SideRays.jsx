...
export { getWebGLRenderBudget } from '../utils/webglPerformance'
...
void main() {
  ...
  gl_FragColor = color;
        ...
        cleanupRef.current = () => {
          ...
          try {
            ...
            // The static hero background remains available if the context is already gone.
          }
  ...
  }, [isVisible, reduceMotion, speed, rayColor1, rayColor2, intensity, spread, origin, tilt, saturation, blend, falloff, opacity])
